...
<input type="hidden" id="url_addtocart" name="url_addtocart" value="Giohang.php">
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            ...
            <div class="header__cart__price"><span><?php echo number_format($giohang->tongtien_giohang())."đ";?></span></div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="Giohang.php"><i class="fa fa-shopping-bag"></i> <span><?php echo count($_SESSION['cart']);?></span></a></li>
                        </ul>
                        <div class="header__cart__price"><span><?php echo number_format($giohang->tongtien_giohang())."đ";?></span></div>
                    </div>
                </div>
                    ...
                    <div class="hero__categories">
                        ...
                        <ul>
                            <?php
                                ...
                                ?>
                            <li><img src="img/banner_fresh.jpg"></li>
                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="Sanpham.php" method="get">
                                <input type="text" name="search" placeholder="Nhập sản phẩm bạn muốn tìm">
                                <button type="submit" name="submit" value="<?php echo $_GET['search']?>" class="site-btn" value="Tìm Kiếm">Tìm Kiếm</button>
                            </form>
                        </div>
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/banner.jpg">
                        <div class="hero__text">
                            <span>CHỢ TRÁI CÂY</span>
                            <h2>Trái cây<br />100% Organic</h2>
                            <p>"Mua rẻ - Mua nhanh"</p>
                            <a href="Sanpham.php" class="primary-btn">MUA NGAY</a>
                        </div>
                    </div>
                </div>
            </div>
